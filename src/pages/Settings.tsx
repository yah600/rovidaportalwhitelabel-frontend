  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
        ...
        <Card className="w-full bg-transparent border-none shadow-none">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-rovida-navy">
              <SettingsIcon className="h-6 w-6 text-rovida-gold" /> {t('settings overview')}
            </CardTitle>
            <CardDescription className="text-rovida-slate-green-gray">
              {t('select category manage settings')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-rovida-slate-green-gray">
              {t('configure app settings description')}
            </p>
          </CardContent>
        </Card>
      </GlassSurface>
      ...
      <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm p-8 card-rovida">
        <p className="text-rovida-slate-green-gray">{t('explore settings navigation left')}</p>
      </div>
    </div>
  );
};
