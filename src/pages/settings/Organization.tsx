        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="grid gap-4">
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-name" className="md:text-right text-rovida-near-black">Organization Name</Label>
            ...
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-address" className="md:text-right text-rovida-near-black">Address</Label>
            ...
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-phone" className="md:text-right text-rovida-near-black">Phone Number</Label>
            ...
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-email" className="md:text-right text-rovida-near-black">Email</Label>
            ...
            <div className="grid md:grid-cols-4 items-start gap-4"> {/* Changed to items-start for textarea */}
              <Label htmlFor="org-description" className="md:text-right text-rovida-near-black">Description</Label>
