...
const SettingsOrganization = () => {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
      <h1 className="text-2xl font-semibold md:text-3xl text-page-title">{t('organization_details')}</h1>

      <Card className="w-full card-rovida">
        <CardHeader>
          <CardTitle className="text-rovida-navy">{t('organization_details')}</CardTitle>
          <CardDescription className="text-rovida-slate-green-gray">{t('manage_org_general_info')}</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="grid gap-4">
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-name" className="md:text-right text-rovida-near-black">{t('organization_name')}</Label>
            ...
            <div className="grid md:grid-cols-4 items-center gap-4">
              <Label htmlFor="org-phone" className="md:text-right text-rovida-near-black">{t('phone_number')}</Label>
